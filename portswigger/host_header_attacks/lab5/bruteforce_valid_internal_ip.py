...
# the main issue faced me writing this script is that , i think whoever have implemented the session from rqeuest have made the cookies associated with Hosts , not Ips 
# and since that this script is chaning the host name -> cookies have not beed send with requests intiated from the same session variable when i changed the host name 
# and the server didn't accept that request without cookie
# Nice thing to know 
proxies = {
